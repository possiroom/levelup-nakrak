...
public class AlterChaserAI : MonoBehaviour
{
    ...
    public void StartChase(Transform player)
    {
        ...
        Debug.Log("[AlterChaserAI] 추격 시작. Target: " + player.name);
    }
    ...
    private void CheckHitByDistance()
    {
        ...
        if (distance <= hitDistance)
        {
            ...
            Debug.Log("[AlterChaserAI] 플레이어와 접촉 판정 발생!");
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            Debug.Log("[AlterChaserAI] Trigger로 플레이어와 접촉!");
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.collider.CompareTag("Player"))
        {
            ...
            Debug.Log("[AlterChaserAI] Collision으로 플레이어와 접촉!");
